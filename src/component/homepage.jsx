...
const filteredProducts = products
  ...
  return (
    <div className="min-h-full">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row gap-3">
  ...
  <input
    ...
    className="border border-gray-300 rounded-lg px-4 py-2 text-sm w-full sm:w-1/3 focus:outline-none focus:ring-2 focus:ring-violet-400"
  />
  ...
  <div className="col-span-4 text-center py-20 text-gray-400 text-lg">
    No products found 😕
  </div>
)}
